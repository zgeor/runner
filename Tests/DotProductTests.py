...
class DotProductTests(unittest.TestCase):
    ...
    def test_accurate_multidimentionalMatrix_sum_returned(self):
        self.assertEqual(20, dot_product([[1,2,3], [1,2,3], [1,2,3]], [[1,2,3], [1,2,3], [1,2,3]]), "Unexpected dot product result.") 
